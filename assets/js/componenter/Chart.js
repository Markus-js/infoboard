  ...
  try {
    ...
    switch (true) {
      ...
      case TempRangeMax <= 60:
        Gradient.addColorStop(0, "rgba(252, 87, 94,0.9)");
        Gradient.addColorPStop(0.5, "rgba(252, 87, 94,0.8)");
      ...
      datasets: [
        {
          data: [
            ...
            Weather.hourly[4].temp,
            Weather.hourly[6].temp,
            Weather.hourly[8].temp,
            Weather.hourly[10].temp,
          ],
        },
      ],
    };
    ...
    for (let i = 0; i < 6; i++) {
      document
        ...
        .setAttribute("href", "#" + Weather.hourly[q].weather[0].main);
